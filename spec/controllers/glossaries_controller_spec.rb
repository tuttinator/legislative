...
RSpec.describe GlossariesController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested glossary as @glossary" do
      glossary = Glossary.create! valid_attributes
      get :show, {:id => glossary.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested glossary as @glossary" do
      glossary = Glossary.create! valid_attributes
      get :edit, {:id => glossary.to_param}, valid_session
      expect(assigns(:glossary)).to eq(glossary)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Glossary" do
        expect {
          post :create, {:glossary => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved glossary as @glossary" do
        post :create, {:glossary => invalid_attributes}, valid_session
        expect(assigns(:glossary)).to be_a_new(Glossary)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested glossary" do
        glossary = Glossary.create! valid_attributes
        put :update, {:id => glossary.to_param, :glossary => new_attributes}, valid_session
        glossary.reload
      ...
      it "assigns the requested glossary as @glossary" do
        glossary = Glossary.create! valid_attributes
        put :update, {:id => glossary.to_param, :glossary => valid_attributes}, valid_session
        expect(assigns(:glossary)).to eq(glossary)
      end
    ...
    describe "with invalid params" do
      it "assigns the glossary as @glossary" do
        glossary = Glossary.create! valid_attributes
        put :update, {:id => glossary.to_param, :glossary => invalid_attributes}, valid_session
        expect(assigns(:glossary)).to eq(glossary)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested glossary" do
      glossary = Glossary.create! valid_attributes
      expect {
        delete :destroy, {:id => glossary.to_param}, valid_session
      }.to change(Glossary, :count).by(-1)
    end
